            ...
            if(_.options.calendarEvents != null) {
                ...
                for (var i = 0; i < _.options.calendarEvents.length; i++) {
                    if(_.$active_date === _.options.calendarEvents[i].date) {
                        ...
                        eventHTML += '<div class="event-info"><p>'+_.options.calendarEvents[i].coursename+'</p></div>';
                        eventHTML += '<div class="event-info"><p>'+_.options.calendarEvents[i].credit+'</p></div>';
                        eventHTML += '</div>';
                ...
                if(!hasEventToday) {
                    eventHTML += '<p class="mt-4">No event for this day.. !</p>';
                }
                eventHTML += '</div>';
